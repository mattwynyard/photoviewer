...
require('./canvasoverlay.js');
const WebGLDebugUtils  = require('./WebGLDebugUtils.js');
...
L.WebGL = L.Class.extend({
  ...
  initShaders : function(vertex, fragment) {
    ...
    if (!this._gl.getProgramParameter(this._sp, this._gl.LINK_STATUS)) {
      console.log("L.WebGL.initShaders(vertex, fragment): [ERR]: could not init shaders");
      return null;
    } else {
  ...
  _compileShader : function(type, source) {
    ...
    if (!this._gl.getShaderParameter(shader, this._gl.COMPILE_STATUS)) {
        console.log("L.WebGL._compileShader(type, shader): [ERR]: shader failed to compile");
